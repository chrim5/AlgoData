 ...
 */
// Stephen Fulwider
//	A sample program to show working examples of
...
public class DFS_BFS
{
    ...
    void DFS() {
        ...
        for (int i=0; i<N; ++i)
            if (!V[i]) {
                ++numComponets;
                System.out.printf("Starting a DFS " +
                        "for component %d starting at node %d%n",numComponets,i);

                DFS(i,V);
            }
        System.out.println();
        System.out.printf("Finished with DFS - found " +
                "%d components.%n", numComponets);
    }
    ...
    void BFS() {
        ...
        for (int i=0; i<N; ++i)
            ...
            {
                ++numComponets;
                System.out.printf("Starting a BFS for component " +
                        "%d starting at node %d%n",numComponets,i);

                BFS(i,V);
            }

        System.out.println();
        System.out.printf("Finished with BFS - found " +
                "%d components.%n", numComponets);
    }
